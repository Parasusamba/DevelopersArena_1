  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero:
          "bg-secondary text-secondary-foreground font-bold shadow-glow hover:shadow-lg hover:-translate-y-1 hover:bg-amber-400",
        heroOutline:
          "border-2 border-secondary/50 bg-transparent text-secondary hover:bg-secondary/10 hover:border-secondary",
        navLink:
          "bg-transparent text-foreground/80 hover:text-foreground hover:bg-muted font-medium",
        navLinkActive:
